...
Para que esse teste passe, você deve permitir que um novo repositório seja cadastrado pela rota **POST** `/repositories`. Caso precise confirmar o formato do objeto, você pode olhar [aqui.](#objDefinition) 
...
Solucionado por **[Kelvyn Costa](https://github.com/kelvyncosta)**